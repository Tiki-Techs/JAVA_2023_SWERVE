...
public class SwerveDrive extends SubsystemBase {
  ...
  SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(SwerveConstants.kDriveKinematics, getAngle(), new SwerveModulePosition[]{
    m_frontLeft.getPosition(),
    m_rearLeft.getPosition(),
    m_frontRight.getPosition(),
    m_rearRight.getPosition()});

  SwerveDriveOdometry m_odometryTur = new SwerveDriveOdometry(SwerveConstants.kDriveKinematics, getAngle(), new SwerveModulePosition[]{
    m_frontLeft.getPosition(),
    m_rearLeft.getPosition(),
    m_frontRight.getPosition(),
    m_rearRight.getPosition()});
  ...
  public void resetOdometryTur() {
    ...
    m_odometryTur.resetPosition(getAngle(), new SwerveModulePosition[]{
      m_frontLeft.getPosition(),
      m_rearLeft.getPosition(),
      m_frontRight.getPosition(),
      m_rearRight.getPosition()}, 
